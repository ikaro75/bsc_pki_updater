...
public class Conexion {
    ...
    public Conexion (Configuracion c, String configuracionActual) throws Fallo {
        LinkedHashMap configuracion = (LinkedHashMap) c.getParametros().get(configuracionActual);
